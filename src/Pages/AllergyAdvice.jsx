    ...
    <div>
      <div className="flex items-center pl-10">
        <div className="w-[50%]">
          <p className="text-3xl text-teal-800  font-bold ml-40">
            {" "}
            <span className="italic">Allergy Advice </span>
          </p>
          <br></br>
          <br></br>
          <p className="text-2xl text-gray-500 ml-40">AT OUR RESTAURANT</p>
          <br></br>
          <h1 className="text-2xl font-bold ml-40">
            We use only the freshest and highest
            <br /> quality ingredients in all our dishes, <br />
            <span className="text-orange-600">
              and offer transparency in our ingredient
              <br /> labeling.
            </span>
          </h1>
        </div>
        <div className="flex items-center">
          <div className="h-[20%] pt-32 ml-35 flex items-center justify-end">
            <img src={AjuNice} />
          </div>
        </div>
      </div>
      <div>
        <div className="flex flex-col justify-center  gap-8 items-center mt-20">
          <h1 className="text-4xl mb-6 text-black font-extrabold">
            <span className="text-orange-600">Ingridient's</span> Used
          </h1>
          <div className="flex h-54 border-teal-800 border-4 rounded-xl w-[40%]  pl-10 ">
            <ul className="  mb-20  list-disc">
              <h1 className="text-black  font-medium  text-2xl mt-4 mb-8">
                For The Dough :
              </h1>
          ...
          <div className="flex border-teal-800 border-4 rounded-xl w-[40%] pl-10 mt-4">
            <ul className=" list-disc mb-8">
              <h1 className="text-black  font-medium text-2xl mt-4 pb-8 ">
          ...
          <div className="flex  border-teal-800 border-4 rounded-xl w-[40%] pl-10 mt-4">
            <ul className=" list-disc mb-8">
              <h1 className="text-black  font-medium text-2xl mt-8 pb-4 mb-4">
      ...
      <div className="flex  mt-20 items-center justify-center">
        <div>
          <h1 className="mb-10 items-center justify-center flex text-4xl font-extrabold ">
            {" "}
      ...
      <div className="flex ml-40 mt-20 items-center w-[80%]  mb-20 bg-slate-100 shadow-xl shadow-slate-400 justify-center">
        <div>
          <h1 className="mb-4 mt-8 items-center justify-center flex w-full text-3xl  font-bold  text-teal-800">
            Scan the QR to Pay
          </h1>
          ...
          <div>
            ...
            <div className="flex flex-row ml-10 items-center justify-center mb-8">
              <p className="text-2xl  font-bold">
                <span className="text-orange-600">Scan</span> Me!
              </p>
              <p className="text-2xl font-bold">
